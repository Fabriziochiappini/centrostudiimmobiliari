...
export default function ChiSiamo() {
  return (
    <div className="animate-fade-in">
      ...
      {/* Quantified Case Studies Section */}
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-montserrat font-bold text-black mb-8 leading-tight">
              I Numeri che <span style={{ color: '#2ca781' }}>Confermano</span> l'Efficacia
            </h2>
            <p className="text-xl md:text-2xl text-gray-600 max-w-5xl mx-auto font-light leading-relaxed">
              Tre esempi concreti di come la nostra <strong className="font-bold text-black">Value Strategy</strong> ha trasformato investimenti ordinari in <strong className="font-bold text-[#2ca781]">storie di successo straordinarie</strong>
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            {/* Case Study 1 - Milano NPL */}
            <Card className="bg-white p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-[#2ca781] group" data-testid="case-study-milano">
              <div className="flex items-center justify-between mb-6">
                <div className="inline-flex items-center px-3 py-1 bg-[#2ca781]/10 rounded-full text-[#2ca781] text-xs font-bold uppercase">
              ...
              <h3 className="text-2xl font-montserrat font-bold text-black mb-4">
                Portfolio NPL Milano
              </h3>
              
              <div className="space-y-4 mb-8">
                <div className="flex items-center text-gray-600">
                  <MapPin className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Milano, Porta Nuova</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Calendar className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Gennaio 2023 - Marzo 2024</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Target className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">3 Unità Residenziali Premium</span>
                </div>
              </div>

              <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl mb-6">
                <h4 className="font-bold text-black mb-4 text-center">RISULTATI FINALI</h4>
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€890K</div>
                    <div className="text-xs text-gray-500 uppercase">Investimento</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€1.4M</div>
                    <div className="text-xs text-gray-500 uppercase">Valore Attuale</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">15</div>
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm text-gray-600 italic">
                  "Acquisto strategico NPL con sconto del 35% sul mercato, ristrutturazione mirata, affitti brevi premium €4.200/mese"
                </p>
              </div>
            </Card>

            {/* Case Study 2 - Firenze Auction */}
            <Card className="bg-white p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-[#2ca781] group" data-testid="case-study-firenze">
              <div className="flex items-center justify-between mb-6">
                <div className="inline-flex items-center px-3 py-1 bg-[#2ca781]/10 rounded-full text-[#2ca781] text-xs font-bold uppercase">
                  <CheckCircle2 className="w-3 h-3 mr-1" />
                  VERIFICATO
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center text-gray-600">
                  <MapPin className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Firenze, Centro Storico</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Calendar className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Settembre 2022 - Dicembre 2023</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Target className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Asta Giudiziaria</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€1.2M</div>
                    <div className="text-xs text-gray-500 uppercase">Investimento</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€2.1M</div>
                    <div className="text-xs text-gray-500 uppercase">Valore Attuale</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">16</div>
                    <div className="text-xs text-gray-500 uppercase">Mesi</div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm text-gray-600 italic">
                  "Acquisizione asta con ribasso del 43%, restauro conservativo, conversione luxury suites €6.800/mese"
                </p>
              </div>
            </Card>

            {/* Case Study 3 - Bologna Saldo e Stralcio */}
            <Card className="bg-white p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 hover:border-[#2ca781] group" data-testid="case-study-bologna">
              <div className="flex items-center justify-between mb-6">
                <div className="inline-flex items-center px-3 py-1 bg-[#2ca781]/10 rounded-full text-[#2ca781] text-xs font-bold uppercase">
                  <CheckCircle2 className="w-3 h-3 mr-1" />
                  VERIFICATO
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center text-gray-600">
                  <MapPin className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Bologna, Zona Universitaria</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Calendar className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Giugno 2023 - Agosto 2024</span>
                </div>
                <div className="flex items-center text-gray-600">
                  <Target className="w-4 h-4 mr-2 text-[#2ca781]" />
                  <span className="text-sm">Saldo e Stralcio</span>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€650K</div>
                    <div className="text-xs text-gray-500 uppercase">Investimento</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">€1.1M</div>
                    <div className="text-xs text-gray-500 uppercase">Valore Attuale</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#2ca781]">14</div>
                    <div className="text-xs text-gray-500 uppercase">Mesi</div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm text-gray-600 italic">
                  "Negoziazione saldo e stralcio al 60%, riqualificazione per studenti, occupancy 98% annua"
                </p>
              </div>
            </Card>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#2ca781] to-[#1a513b] rounded-2xl p-8 md:p-12 text-white">
            <div className="text-center mb-8">
              <h3 className="text-3xl md:text-4xl font-montserrat font-bold mb-4">
                Impatto Complessivo dei Case Studies
              </h3>
              <p className="text-xl text-white/90 font-light">
                Risultati tangibili che dimostrano l'efficacia della Value Strategy
              </p>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-yellow-300 mb-2">€2.74M</div>
                <div className="text-sm md:text-base text-white/80 uppercase tracking-wide">Investimenti Totali</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-yellow-300 mb-2">€4.6M</div>
                <div className="text-sm md:text-base text-white/80 uppercase tracking-wide">Valore Generato</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-yellow-300 mb-2">+67%</div>
                <div className="text-sm md:text-base text-white/80 uppercase tracking-wide">ROI Medio</div>
              </div>
              <div className="text-center">
                <div className="text-4xl md:text-5xl font-bold text-yellow-300 mb-2">15</div>
                <div className="text-sm md:text-base text-white/80 uppercase tracking-wide">Mesi Medi</div>
              </div>
            </div>
            <div className="text-center mt-8">
              <p className="text-lg text-white/90 italic">
                "I dati parlano chiaro: la Value Strategy non è teoria, è realtà misurata e replicabile"
              </p>
            </div>
          </div>
        </div>
